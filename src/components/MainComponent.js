...
import {  fetchCampsites, fetchComments, fetchPartners, fetchPromotions, postComment, postFeedback } from '../redux/ActionCreators';
                ...
                <TransitionGroup>
                    <CSSTransition key={this.props.location.key} classNames="page" timeout={300}>
                        <Switch>
                            ...
                            <Route path='about/:CampsiteId' component={CampsiteWithId} />
                            <Redirect to='/home' />
                        </Switch>
                    </CSSTransition>
                </TransitionGroup>    
